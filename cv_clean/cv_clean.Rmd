...
publications_table <- publications %>%
  mutate(year = ifelse(str_detect(year, "Forthcoming|Conditional"), str_c("9",year),year)) %>%
  arrange(desc(year), authors) %>%
  mutate(year = ifelse(str_detect(year, "Forthcoming|Conditional"), str_remove(year, "^9"),year)) %>%
