...
output:
  pagedown::html_paged:
    ...
    #CDS
    # css: ["https://use.fontawesome.com/releases/v5.15.3/css/all.css", "style/one-column-paged.css"]
    css: "style/one-column-paged.css"
    #offline
    #css: ["style/one-column-paged.css", "fontawesome-free-5.8.1-web/css/all.css"]
