...
css_file  <- gsub(pattern = "(DATE_PLACEHOLDER)|(\\d\\d? [A-Za-z]{3} \\d{4})", replace = str_glue("{day(current_date)} {month(current_date, label = TRUE, abbr = TRUE)} {year(current_date)}"), x = css_file)
